...
window.addEventListener('load', function () {
    ...
    // Eingang B Gebäude
    const eingang3 = new PANOLENS.ImagePanorama('../public/assets/images/eingang3.jpg');
    const eingang2 = new PANOLENS.ImagePanorama('../public/assets/images/eingang2.jpg');
    const eingang1 = new PANOLENS.ImagePanorama('../public/assets/images/eingang1.jpg');
    // 1. Etage
    const flur1_1 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur1.jpg');
    const flur1_2 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur2.jpg');
    const flur1_3 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur3.jpg');
    const flur1_4 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur4.jpg');
    const flur1_5 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur5.jpg');
    const flur1_6 = new PANOLENS.ImagePanorama('../public/assets/images/1-flur6.jpg');
    const computerraum= new PANOLENS.ImagePanorama('../public/assets/images/computerraum.jpg');
    // 2. Etage
    const flur2_1 = new PANOLENS.ImagePanorama('../public/assets/images/2-flur1.jpg');
    const flur2_2 = new PANOLENS.ImagePanorama('../public/assets/images/2-flur2.jpg');
    const flur2_3 = new PANOLENS.ImagePanorama('../public/assets/images/2-flur3.jpg');
    // Treppenhaus
    const treppenhaus1 = new PANOLENS.ImagePanorama('../public/assets/images/treppenhaus1.jpg');
    const treppenhaus2 = new PANOLENS.ImagePanorama('../public/assets/images/treppenhaus2.jpg');
    const treppenhaus3 = new PANOLENS.ImagePanorama('../public/assets/images/treppenhaus3.jpg');
    const treppenhaus4 = new PANOLENS.ImagePanorama('../public/assets/images/treppenhaus4.jpg');
    const treppenhaus5 = new PANOLENS.ImagePanorama('../public/assets/images/treppenhaus5.jpg');
    ...
    viewer.add(aula1,aula2,aula3,aula4,aula5,
        ...
        computerraum,flur2_1,flur2_2,flur2_3,
